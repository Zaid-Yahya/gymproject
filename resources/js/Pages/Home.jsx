    ...
    return (
        <>
            ...
            <div className={`transition-colors duration-700 ${isDarkMode ? 'bg-gray-900' : 'bg-white'}`}>
                {/* Navigation Bar */}
                <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-500 ${isDarkMode ? 'bg-gray-900 text-white shadow-lg' : 'bg-white shadow-sm'}`}>
                    <div className="container mx-auto px-6">
                        <div className="flex justify-between items-center py-4">
                            {/* Logo */}
                            <div className="text-2xl font-extrabold">
                                <span className="text-red-500">POWER</span>
                                <span className={isDarkMode ? 'text-white' : 'text-gray-800'}>GYM</span>
                            </div>
                            ...
                            <div className="hidden md:flex space-x-8">
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'hero' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'hero' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    HOME
                                </button>
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'gallery' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'gallery' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    GALLERY
                                </button>
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'programs' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'programs' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    PROGRAMS
                                </button>
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'trainers' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'trainers' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    TRAINERS
                                </button>
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'testimonials' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'testimonials' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    TESTIMONIALS
                                </button>
                                <button 
                                    ...
                                    className={`text-sm font-medium transition-all duration-300 ${
                                        isDarkMode 
                                            ? (activeSection === 'membership' ? 'text-red-500' : 'text-gray-300 hover:text-red-400')
                                            : (activeSection === 'membership' ? 'text-red-500' : 'text-gray-700 hover:text-red-500')
                                    }`}
                                >
                                    MEMBERSHIP
                                </button>
                            ...
                            <div className="hidden md:flex items-center space-x-4">
                                ...
                                <Link 
                                    href={route('register')} 
                                    className="px-6 py-2 bg-red-500 text-white rounded-full hover:bg-red-600 transition-all duration-300 hover:scale-105 transform"
                                >
                                    Join Now
                                </Link>
                            </div>
                        ...
                        <div className={`md:hidden transition-all duration-500 overflow-hidden ${mobileMenuOpen ? 'max-h-96 mt-4' : 'max-h-0'}`}>
                            <div className={`flex flex-col space-y-4 pt-2 pb-4 rounded-lg shadow-lg ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                                <button 
                                    onClick={() => scrollToSection(heroRef, 'hero')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'hero' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    HOME
                                </button>
                                <button 
                                    onClick={() => scrollToSection(galleryRef, 'gallery')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'gallery' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    GALLERY
                                </button>
                                <button 
                                    onClick={() => scrollToSection(programsRef, 'programs')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'programs' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    PROGRAMS
                                </button>
                                <button 
                                    onClick={() => scrollToSection(trainersRef, 'trainers')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'trainers' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    TRAINERS
                                </button>
                                <button 
                                    onClick={() => scrollToSection(testimonialsRef, 'testimonials')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'testimonials' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    TESTIMONIALS
                                </button>
                                <button 
                                    onClick={() => scrollToSection(membershipRef, 'membership')}
                                    className={`text-sm font-medium py-2 transition-all duration-300 ${activeSection === 'membership' ? 'text-red-500' : 'text-gray-700'}`}
                                >
                                    MEMBERSHIP
                                </button>
                                <div className="pt-2 flex flex-col space-y-3 px-4">
                                    <Link 
                                        href={route('login')} 
                                        className="py-2 text-gray-700 hover:text-red-500 transition-all duration-300"
                                    >
                                        Login
                                    </Link>
                                    <Link 
                                        href={route('register')} 
                                        className="py-2 bg-red-500 text-white text-center rounded-full hover:bg-red-600 transition-all duration-300"
                                    >
                                        Join Now
                                    </Link>
                                </div>
                                    ...
                                    >
                                        <h1 className="text-[2.5rem] md:text-[3.5rem] font-bold leading-tight">
                                            ...
                                            >
                                                ...
                                                <span className="text-red-500 ml-3">CORPS</span>
                                            ...
                                            >
                                                <span className="text-white">TRANSFORMEZ VOTRE</span>
                                                <span className="text-red-500 ml-3">VIE</span>
                                            </motion.div>
                                        </h1>
                                        ...
                                        <motion.p 
                                            ...
                                            className="text-xl text-gray-300 mt-8 mb-10"
                                        >
                                            Rejoignez l'élite du fitness à Paris
                                        </motion.p>
                                        ...
                                        >
                                            <Link
                                                href={route('register')}
                                                className="inline-block px-8 py-4 bg-red-500 text-white text-lg font-medium rounded-lg hover:bg-red-600 transform hover:scale-105 transition-all duration-300"
                                            >
                ...
                {/* Gallery Section - Dark theme when active */}
                <section ref={galleryRef} className={`py-24 relative overflow-hidden ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-gray-100 to-white'}`}>
                    {/* Background gradient */}
                    ...
                    {/* Red accent shape */}
                    <div className="absolute top-1/2 left-0 transform -translate-y-1/2 w-64 h-96 bg-red-200 rounded-r-full opacity-30 blur-3xl"></div>
                    
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            <h2 className={`inline-block text-3xl md:text-5xl font-bold mb-4 relative ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>
                                OUR GALLERY
                                <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-red-500"></div>
                            </h2>
                ...
                {/* Programs Section - Updated with light/dark combination */}
                <section ref={programsRef} className={`py-24 relative overflow-hidden ${isDarkMode ? 'bg-gray-800' : 'bg-gradient-to-b from-white to-gray-100'}`}>
                    {/* Background elements */}
                    <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-white to-transparent"></div>
                    <div className="absolute bottom-0 left-0 w-full h-64 bg-gradient-to-t from-gray-100 to-transparent"></div>
                    
                    {/* Red accent shape */}
                    <div className="absolute top-1/2 right-0 transform -translate-y-1/2 w-64 h-96 bg-red-200 rounded-l-full opacity-30 blur-3xl"></div>
                    
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            <h2 className="inline-block text-3xl md:text-5xl font-bold text-gray-800 mb-4 relative">
                                OUR PROGRAMS
                                <div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-red-500"></div>
                            </h2>
                ...
                {/* Membership Plans Section - Updated with light theme */}
                <section ref={membershipRef} className={`py-24 relative overflow-hidden ${isDarkMode ? 'bg-gray-900' : 'bg-gradient-to-b from-gray-100 to-white'}`}>
                    {/* Background elements */}
                    <div className="absolute -top-20 -right-20 w-80 h-80 bg-red-200 rounded-full opacity-30 blur-3xl"></div>
                    <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-red-200 rounded-full opacity-30 blur-3xl"></div>
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-600 max-w-2xl mx-auto">
                                Choose the membership plan that fits your fitness journey and goals.
                            </p>
                        </div>
                                    ...
                                    >
                                        ...
                                        <div className={`p-8 ${isPopular ? 'pt-10' : ''}`}>
                                            ...
                                            <Link
                                                ...
                                                className={`w-full py-3 px-4 rounded-full text-center font-bold transition-all duration-300 ${
                                                    isPopular 
                ...
                <section className="py-24 bg-black relative overflow-hidden">
                    {/* Background elements */}
                    <div className="absolute -top-40 -left-40 w-80 h-80 bg-red-600 rounded-full opacity-10 blur-3xl"></div>
                    <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-red-600 rounded-full opacity-10 blur-3xl"></div>
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-gray-400 max-w-2xl mx-auto">
                                Track your fitness progress by calculating your Body Mass Index (BMI). Get personalized insights and recommendations.
                            </p>
                        </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                                <div className="space-y-6">
                                    <div className="space-y-2">
                                        <h3 className="text-2xl font-bold text-white">Why Calculate BMI?</h3>
                                        <p className="text-gray-400">BMI is an important indicator of your health status and can help you:</p>
                                    </div>
                                    ...
                                    <ul className="space-y-4">
                                        <li className="flex items-start space-x-3">
                                            ...
                                            <span className="text-gray-300">Assess your weight category</span>
                                        </li>
                                        <li className="flex items-start space-x-3">
                                            <svg className="w-6 h-6 text-red-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <span className="text-gray-300">Track your fitness progress</span>
                                        </li>
                                        <li className="flex items-start space-x-3">
                                            <svg className="w-6 h-6 text-red-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                            </svg>
                                            <span className="text-gray-300">Get personalized health insights</span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="text-center">
                                    <div className="mb-8">
                                        <img 
                                            ...
                                            alt="BMI Calculator"
                                            className="w-32 h-32 mx-auto rounded-full object-cover border-4 border-red-500 shadow-xl"
                                        />
                                    </div>
                                    <Link
                                        href={route('bmi.calculator')}
                                        className="inline-block px-8 py-4 bg-red-600 text-white font-bold rounded-full hover:bg-red-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-red-600/30"
                                    >
                ...
                {/* Footer - Keep dark theme for contrast */}
